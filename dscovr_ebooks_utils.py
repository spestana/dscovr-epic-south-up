...
def make_animation():
	...
	# list of image magick options we want to use for convert
	...
	for i, image in enumerate(recent_images):
		with tempfile.NamedTemporaryFile(dir='tmp/', prefix=f'tmp{i}_', suffix=f'.png', delete=False) as downloadfile:
